...
console.log(
  `Facebook Activity Scrubber content script loaded at: ${SCRIPT_LOAD_TIME}`
);
...
(function initDebugTools() {
  ...
  setTimeout(() => {
    console.log(
      'Initializing Facebook Activity Scrubber debugging tools (hidden mode)...'
    );
...
function addStatusIndicator() {
  ...
  addLogMessage('Facebook Activity Scrubber initialized');
...
function addDebugPanel(hidden = false) {
  ...
  header.style.cssText = `
    ...
    padding-bottom: 5px;
  `;
  header.innerHTML = `<strong>Facebook Activity Scrubber Debug (v${SCRIPT_LOAD_TIME})</strong>`;
